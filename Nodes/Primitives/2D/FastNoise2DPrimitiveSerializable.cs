...
[PrettyTypeName("Fast Noise 2D")]
[Serializable]
public sealed class FastNoise2DPrimitiveSerializable : Primitive2DNodeSerializable
{
    public override string Title {
        get { return "Fast Noise 2D"; }
    }
    ...
    [SerializeField] private FastNoise2DPrimitiveSerializable cellularNoise;
    ...
    {
        return new FastNoise2DPrimitive(CreateFastNoise(), scale);
    }
}