...
public class AdditiveSphereEditor : IOperationEditor
{
    ...
    public virtual void OnInspector(TerrainToolEditor editor)
    {
        ...
        Speed = EditorGUILayout.Slider("Speed:", Speed, 0.001f, 1f);
    ...
    protected virtual IOperation CreateOperationFromEditor(Vector3 worldPosition, TerrainToolEditor editor)
    {
        ...
        return AdditiveSphere.CreateFromUnityWorld(editor.Terrain, Dig, worldPosition, Radius, Speed, voxelType);
    }
}